...
![Badge C#](https://img.shields.io/badge/C%23-.NET%208-blue?logo=c-sharp)
![Badge Angular](https://img.shields.io/badge/Angular-17-red?logo=angular)
![Badge PostgreSQL](https://img.shields.io/badge/PostgreSQL-blue?logo=postgresql)
![Badge Microsserviços](https://img.shields.io/badge/Arquitetura-Microsserviços-purple)
...
Crie dois bancos de dados separados no seu PostgreSQL (ex: `stockdb` e `billingdb`).
...
Você precisa aplicar as migrations para que o EF Core crie as tabelas em ambos os bancos. Execute os comandos abaixo no terminal para cada projeto de backend (BillingService e StockService):
```
